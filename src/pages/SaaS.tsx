...
const SaaS = () => {
  const packages = [
    ...
    },
    {
      ...
      price: "R10,000/month",
      description: "Dedicated monthly services - No commitment, cancel anytime",
      features: [
  ...
  const comparison = [
    ...
    },
    {
      ...
      traditional: "R50-R100K invested before validating if your idea has market traction",
        ...
        <div className="container mx-auto px-4 lg:px-6">
          <div className="text-center max-w-4xl mx-auto animate-fade-in">
            <Badge className="mb-6 bg-primary/10 text-primary border-primary/20">
              ...
              Only 3 spots available for May
            </Badge>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button size="lg" variant="outline" asChild>
                <Link to="/clients">View Our Projects</Link>
              </Button>
            </div>
            <p className="text-sm text-muted-foreground mt-4">
              We're accepting only 3 new clients for May. Fill out the form to share your vision, we'll reply within 24 hours.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-6xl mx-auto">
            <Card className="overflow-hidden">
              ...
              {comparison.map((item, index) => (
                <div key={index} className="grid grid-cols-3 p-4 border-b last:border-b-0 text-sm">
            ...
            {packages.map((pkg, index) => (
              <Card key={index} className={`hover-lift animate-scale-in relative ${pkg.popular ? 'border-primary shadow-lg' : ''}`} style={{animationDelay: `${index * 200}ms`}}>
                ...
                <CardHeader className="text-center">
                  ...
                  {pkg.name.includes("MVP") && (
                    <Badge variant="outline" className="mx-auto">
                      Limited availability - Only 3 spots for May
                    </Badge>
                  )}
                </CardHeader>
                <CardContent>
